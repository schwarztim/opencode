...
You can also grab prebuilt binaries and desktop installers from the [Releases](https://github.com/sst/opencode/releases).

- **Linux ARM64 desktop builds** are available (look for `aarch64` / `arm64` assets).
