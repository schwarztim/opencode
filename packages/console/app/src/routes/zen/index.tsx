          ...
          <div data-component="center">
            <div data-slot="hero-copy">
              <img data-slot="zen logo dark" src={zenLogoDark}
                   alt="Zen logo dark"/>
              <strong>High quality coding models configured for speed and
                cost</strong>
              <p>OpenCode works with leading AI providers to configure the most
                accurate, fastest, and cheapest coding models available. </p>
              <button>
                Get started with Zen
              </button>
            </div>
            <div data-slot="pricing-copy">
              <p><strong>$20 Balance</strong> <span>(+$1.23 card fee)</span></p>
              <p>No subscriptions. No markups. No hidden costs. Only card
                fees.</p>
